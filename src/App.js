      ...
      <main role="main">
        <div className="jumbotron d-flex align-items-center justify-content-center">
          <div className="container">
            <h1 className="display-3">Detect Common Skin Diseases !</h1>
            <p>
              This is an application which enables common users to find out
              about skin diseases from the comfort of their home.
            </p>
            <div className="row">
